...
void main(){
    ...
    // change the distortion effect here
    float ratio = clamp(1.0 - dist * 12., 0., 1.);
...
void main(){
    ...
    float offsetOutProgress = clamp(1.-waveOut,0.,2.);
    ...
    pos.z += sin(distance * 9. - u_time * 1.7 )  * u_waveIntensity;
