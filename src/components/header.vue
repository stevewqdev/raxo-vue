            ...
            <div class="navbar__wrapper">
                ...
                <div class="frame">
                    <div class="logo" data-aos="fade-down" data-aos-delay="600">
                        <router-link to="/">
                            <img class="logo__white" src="../assets/raxo-white.svg" alt="Raxo-Logo">	
                            <img class="logo__black" src="../assets/raxo-black.svg" alt="Raxo-Logo">
                        </router-link>
                    </div>
                </div> 
            </div>
...
export default {
  ...
  methods: {
    toggleNavbar () {
        let navbarEl = document.getElementById("mySidenav").classList;
        if(navbarEl.contains('openedDesktop') || navbarEl.contains('openedMobile')){
            document.getElementById("mySidenav").classList.remove('openedDesktop');
            document.getElementById("mySidenav").classList.remove('openedMobile');
...
<style>
    ...
    .menu__icon i{
        transition: font-size cubic-bezier(0.645, 0.045, 0.355, 1) 0s, width cubic-bezier(0.645, 0.045, 0.355, 1) 0.3s, height cubic-bezier(0.645, 0.045, 0.355, 1) 0.3s 0.6s;
        position: relative;  
    }
    ...
    .logo__white.show__logo, .logo__black.show__logo{
        opacity: 1;
    }
