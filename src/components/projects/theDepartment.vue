...
<meta name="description" content="Our Work Portfolio - The Department. They came to Raxo for Design & Web Development. We fulfilled their requirements within a specific timeline. Contact us today at 646-838-4583!">
		<div class="home-page dark-logo">
	<div class="home-page-21-overlay light"></div>
	<div class="center-container">
		<div class="center-block">
			<h1 class="home-page-21-title light" data-aos="fade-in" data-aos-duration="2000">
			Immersive
			</h1>
...
<section class = "section-3">
	<div class="cont-1 container">
		...
		<div class="row" data-aos="fade-in" data-aos-duration="2000">
			...
			<div class="col-md-7">
				<p>A groundbreaking immersive agency and mixed reality studio with scale, tech, and human credes. The Department approached RAXO in search of a complete website revamp that adhered to the style and grandeur of work that they do. We created a dynamic website that truly goes all out!
				</p>
			<br>
			</div>
		</div>
...
<section class="blackcrcle">
    <div class="container">
	   <div class="row">
	       <div class="col-md-12" data-aos="fade-up" data-aos-anchor-placement="center center">
		       <h1 class="middle-title">A groundbreaking immersive agency and mixed<br>reality studio with scale, tech and human creds<font></font></h1>
		   </div>
	   </div>
	</div>
</section>
...
<section class = "new-section-21-1">
   <div class="container">
      ...
      <h6>RAXO made sure the website was fully <br> responsive through mobile with the dynamic<br> graphics and videography.</h6>
      </div>
