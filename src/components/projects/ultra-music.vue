...
<meta name="description" content="Our Work Portfolio - Ultra Music. They came to Raxo for Design, Animation and Web Development. We fulfilled their requirements within a specific timeline. Contact us today at 646-838-4583!">
		<div class="home-page dark-logo">
  <div class="home-page-26-overlay light"></div>
  <div class="center-container">
    <div class="center-block">
      <h1 class="home-page-26-title light" data-aos="fade-in" data-aos-duration="2000"> DropTheBass</h1>
...
<section class = "section-3">
  <div class="cont-1 container">
    ...
    <div class="row" data-aos="fade" data-aos-duration="2000">
      ...
      <div class="col-md-7">
        <p>Ultra Music is a worldwide music entity, comprising Ultra Records, Ultra Music Publishing, and Empire Artist Management. Ultra came to RAXO with the task of creating animated music snippets, social media banners and snapchat stickers for individual artists that comes out with new music. RAXO created a personalized animation for artists’ album covers, making each animation individually different.</p>
        <br>
      </div>
    </div>
    <div class="row" data-aos="fade" data-aos-duration="2000">
...
<section class = "section-4 ultra-black" style="background-color:#000;height: 100%;background-size: cover;background-position: center center;">
  <div class="center-container">
    <div class="center-block">
...
<section class = "new-section-26-11 ultra-snap">
   <div class="container">
    ...
    <div class="row mobanimation" onmousewheel="toggleClass(this, 'pic_translate')">
      <div class="col-xs-12 col-sm-6 col-md-4">
        <div class="mobile-new-box" data-aos="fade-up" data-aos-duration="2000">
          ...
          <div class="mobile-box-content bottom-content-right-2 light-text red-crcl back-curl-icon">
            <h2>CARNAGE</h2>
            <p>Carnage released a new track titled “Papi Gordo” and RAXO created Snapchat stickers that really translate different aspects of the song.</p>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-sm-6 col-md-4">
