...
<meta name="description" content="Our Work Portfolio - Onboard Informatics. They came to Raxo for Design and Web Development. We fulfilled their requirements within a specific timeline. Contact us today at 646-838-4583!">
...
<section class="parallax-window onboard-fondo1" data-parallax="scroll" data-image-src="assets/img/16-page-1.png" >
  <div class="center-container">
    <div class="center-block">
...
<section class = "section-3">
  <div class="cont-1 container">
    ...
    <div class="row" data-aos="fade-in" data-aos-duration="2000">
      ...
      <div class="col-md-7">
        <p>Onboard Informatics develops innovative web technology and APIs that serve to provide users and web developers
          with accurate housing, school and neighborhood data for
          real estate firms all over the United States. We designed various web pages for them to showcase each individual
          API and its value in the real estate sector.</p>
        <br>
      </div>
    </div>
    <div class="row" data-aos="fade-in" data-aos-duration="2000">
  ...
  <div class="center-container">
    <div class="center-block">
      <div class = "container">
        <div class ="row">
          <div class = "col-sm-12">
            <h1 class = "page-16-head page-16-head-custom"> Build the best with the best.
              Get complete premium data on every
              property and neighborhood in the
              country for your project. </h1>
          </div>
        </div>
      </div>
    </div>
...
<section class="section-7 onboard-website" style="padding:30px 0 100px 0">
  <div class="container-fluid">
    <div class="row">
      <div class="sec-head col-xs-12 col-sm-8 col-md-3 col-md-offset-1" data-aos="fade-out">
    ...
    <div class="row">
      <div class="sec-head col-xs-12 col-sm-6 col-md-3 col-md-offset-1" data-aos="fade" data-aos-duration="2000">
