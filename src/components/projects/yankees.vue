...
<meta name="description" content="Our Work Portfolio - New York Yankees. They came to Raxo for Design. We fulfilled their requirements within a specific  timeline. Contact us today at 646-838-4583!">
		<div class="home-page dark-logo">
  <div class="home-page-13-overlay light yankees-fondo1"></div>
  <div class="center-container">
    <div class="center-block">
      <h1 class="home-page-10-title light" data-aos="fade-in" data-aos-duration="2000"> HomeRun </h1>
...
<section class = "section-3">
  <div class="cont-1 container">
    ...
    <div class="row" data-aos="fade-in" data-aos-duration="2000">
      ...
      <div class="col-md-7">
        <p>The New York Yankees came to RAXO for their overall, out-of-the-park design. We’ve grown into a full-service team that the Yankees marketing department relies on for innovative messaging and strategy. We’re often trusted to conceive, execute and place B2B and B2C print ads; craft a digital dominance across strategically chosen sites; and design a huge range of collectible posters for die-hard fans. </p>
        <br>
      </div>
    </div>
    <div class="row" data-aos="fade-in" data-aos-duration="2000">
...
<section class = "new-section-13-4 yankees-design">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xs-12 col-sm-3 col-md-2" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
        <h1 class = "head-5">Invite<br>
          Design</h1>
      </div>
      <div class="col-xs-12 col-sm-9 col-md-3" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
        <p class = "end-para">Getting invited to a Yankees Special Event should be a memorable experience with design that really reflects the brand and the energy that the team and the game gives.</p>
      </div>
    </div>
  </div>
</section>
