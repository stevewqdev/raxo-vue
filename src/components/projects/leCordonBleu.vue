...
<meta name="description" content="Our Work Portfolio - Le Cordon Bleu. They came to Raxo for Design, Web Development and Strategy. We fulfilled their requirements within a specific timeline. Contact us today at 646-838-4583!">
		<div class="home-page dark-logo">
  <div class="home-page-6-overlay light"></div>
  <div class="center-container">
    <div class="center-block">
      <h1 class="home-page-6-title light" data-aos="fade-in" data-aos-duration="2000"> CulinaryExcellence </h1>
      <p style="color:#1a2944;" class="banner-slogon-text">Design. Web Development. Strategy.</p>
    </div>
  </div>
</div>
<section class = "section-3">
  <div class="cont-1 container">
    ...
    <div class="row" data-aos="fadeIn" data-aos-duration="2000">
      ...
      <div class="col-md-7">
        <p>Le Cordon Bleu is without a doubt the world’s premier name in culinary education. So it’s no surprise that we we’re excited to work with them on their recent rebranding campaign—
          a campaign that included everything from magazine advertising elements and social media banners to a full social media overhaul highlighting the unequaled and legendary presence of the school through our own strategy, copy, analytics, and design. </p>
        <br>
      </div>
    </div>
    <div class="row" data-aos="fadeIn" data-aos-duration="2000">
...
<section class = "new-section-6-2 lcb-txt">
  <div class="container">
    <div class="col-xs-12">
      <h3 class="big-text" style="color:#1b3661;">When trying to settle on a brand image, we found inspiration in their worldly presence. We use a classy, unified design rich in  blues and golds. We focused on imagery that was unique to each city where their schools are. Tokyo, London, Lebanon and beyond! </h3>
    </div>
  </div>
</section>

<section class="new-section-6-4 lcb-sections" style = "background-color:#223265 !important;padding-bottom: 80px;">
  <div class="container-fluid">
    <div class="row">
      <div class="sec-head col-md-3 col-md-offset-1" data-aos="fade-out">
        <h1 style="color: #fff;" class="web section-side-heading">Sections</h1>
    ...
    <div class="row">
      <div class="sec-head col-md-3 col-md-offset-1" data-aos="fade-out" data-aos-duration="500">
        <h4 class="pro brown">Location  </h4>
        <div class="row">
          <div class="col-md-12">
            <div class = "circle-8"  data-aos="slide-right" data-aos-duration="2000"></div>
          </div>
          <div class="col-md-10">
            <div class = "circle-9"  data-aos="slide-right" data-aos-duration="2000"></div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="sec-head col-md-3 col-md-offset-1" data-aos="fade-out" data-aos-duration="500">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class = "circle-11"  data-aos="slide-right" data-aos-duration="2000"></div>
          </div>
          <div class="col-md-10">
            <div class = "circle-12"  data-aos="slide-right" data-aos-duration="2000"></div>
          </div>
        </div>
      </div>
...
<section class = "new-section-6-7 lcb-smedia">
  <div class="new-cont-4 container">
    <h1 class="web section-side-heading">Social Media<br>
      Posts</h1>
    <p>RAXO creates Instagram and Social Media<br>
      posts for Le Cordon Bleu that really fits with<br>
      their style and promotes their culinary expertise.</p>
  </div>
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-12">
