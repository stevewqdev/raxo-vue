...
<meta name="description" content="Our Work Portfolio - Engine Shop. They came to Raxo for Design, Branding and Web Development. We fulfilled their requirements within a specific  timeline. Contact us today at 646-838-4583!">
...
<section class = "section-3">
  <div class="cont-1 container" data-aos="fade-in" data-aos-duration="2000">
    ...
    <div class="row">
      ...
      <div class="col-md-7">
        <p>Engine Shop specializes in helping brands connect with consumers online and in-person through live experiences, digital engagement and original and branded content. Engine Shop came to RAXO looking to refresh its visual identity in order to support its growing leadership in the engagement marketing world. After an extensive analysis of Engine Shop’s core ideals, RAXO commenced work on a comprehensive update of the company’s logo, brand guidelines, and new business collateral, implementing a fresh approach to typography and color.</p>
        <br>
      </div>
    </div>
    <div class="row">
...
<section class = "new-section-1">
  <div class="container">
    <div class="row">
      <div class="col-md-10 col-md-offset-1" data-aos="fade-up" data-aos-offset="-200" data-aos-anchor-placement="bottom-bottom">
        <h1 class="bg-text-c">#Convention #Festival <br>
          #WebDesign  #People <br>
          #Responsive #Digital <br>
          #NewYork #Convention <br>
          #Movement #Sustainable</h1>
      </div>
    </div>
...
<section class="new-section-2" style="background:#000000; padding:100px 0;">
  <div class="container" data-aos="fade" data-aos-duration="3000">
    ...
    <div id="mobanimation" class="row" onmousewheel="toggleClass(this, 'pic_translate')">
      <div class="col-xs-12 col-sm-6 col-md-4">
        <div class="mobile-new-box">
          ...
          <div class="mobile-box-content bottom-content-right-2 light-text red-crcl back-curl-icon">
            <h2>MENU</h2>
            <p>Large text was used to easily translate the menu from desktop to mobile.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-12 col-sm-6 col-md-4">
        <div class="mobile-new-box">
          ...
          <div class="mobile-box-content bottom-content-left light-text red-crcl back-curl-icon back-curl-icon-slash">
            <h2>CASE STUDIES</h2>
            <p>Large imagery was used on the case studies to clearly display work done by EngineShop.</p>
          </div>
        </div>
      </div>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="sec-head col-md-3" data-aos="fade-out">
        <h1 style="color:#d7262e;" class="web section-side-heading">Website</h1>
        <h4 class = "pro">CASE STUDIES </h4>
        <span class="box"></span>
        <p class = "para">Throughout the website, RAXO used large iconography and imagery to clearly show the compelling work of EngineShop.</p>
        <div class = "circle-1" data-aos="slide-right" data-aos-duration="5000"></div>
      </div>
    </div>
    <div class="row">
      <div class="big-circle col-md-4 hidden-xs hidden-sm">
        <div class = "circle-2" data-aos="slide-right" data-aos-duration="2000"></div>
      </div>
    ...
    <div class="row">
      <div class="sec-head col-md-3 hidden-md hidden-lg" data-aos="fade" data-aos-duration="2000">
        <h4 class="pro">TEAM  </h4>
      <div class = "circle-3"  data-aos="slide-right" data-aos-duration="2000"></div>
      </div>
    ...
    <div class="row">
      ...
      <div class="sec-head col-md-3 col-md-offset-1" data-aos="fade" data-aos-duration="2000">
        ...
        <div class = "circle-4"  data-aos="slide-right" data-aos-duration="2000"></div>
      </div>
