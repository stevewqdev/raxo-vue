<template>
    ...
    <meta name="description" content="Our Work Portfolio - Awake. They came Raxo for Branding & Catalog Design. We fulfilled requirements within a specific  timeline. Contact us today at 646-838-4583!">
    ...
    <section class="section-3">
        <div class="cont-1 container">
          ...
          <div class="row aos-init aos-animate" data-aos="fade" data-aos-duration="2000">
            ...
            <div class="col-md-7">
              <p>Awake designs and prints high-resolution graphics on specialty engineered fabrics to create modern backlit installations and acoustic ceiling &amp; wall treatments. They provide both commercial and residential clients with gorgeous ceiling, lighting, and acoustic solutions. Awake came to RAXO for branding, as well as for an imaginative, bodacious catalog design.</p>
              <br>
            </div>
          </div>
          <div class="row aos-init aos-animate" data-aos="fade" data-aos-duration="2000">
        ...
        <div class="container">
          <div class="row d-flex justify-content-center">
            <div class="col-md-10 aos-init aos-animate" >
              <h1>We gave Awake a look and feel that truly speaks to their work as artists in the architecture and interior realm. The logo was designed with the idea of it not competing with the work in their portfolio while being memorable to their clients.</h1>
            </div>
          </div>
        </div>
      </section>
    ...
    <section class="section-slider-page-32 page-33 aos-init aos-animate" data-aos-duration="2000" data-aos="fade-up">
        <div class="slider">
            ...
            <div class="slider__inner">
              <div class="slider__contents">
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="info aos-init aos-animate" data-aos-duration="2000" data-aos="">
    ...
    <section class="section-15-page-29 page-33 section-15-33" style="position: relative;top: -2px;">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <div class="info aos-init aos-animate" data-aos-duration="2000" data-aos="fade-right">
                <h3>Sample Book</h3>
