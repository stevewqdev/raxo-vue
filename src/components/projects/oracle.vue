...
<meta name="description" content="Our Work Portfolio - Oracle - American multinational computer technology corporation. They came to Raxo for Design, Strategy, and Web Development. We fulfilled their requirements within  a specific timeline. Contact us today at 646-838-4583!">
...
<section class = "section-3">
  <div class="cont-1 container">
    ...
    <div class="row" data-aos="fade-in" data-aos-duration="2000">
      ...
      <div class="col-md-7">
        <p>Oracle is an American multinational computer technology corporation. Oracle’s wide-ranging breadth of software solutions for an array of industries means the company is always looking for innovative ways to reach new or existing customers. RAXO’s work for Oracle revolves around a variety of marketing techniques and channels, including direct marketing, campaign development, and management of new software solutions, as well as web development, online and print materials. </p>
        <br>
      </div>
    </div>
    <div class="row" data-aos="fade-in" data-aos-duration="2000">
...
<section class = "new-section-8-1 oracle-desktop" style="background-color:#000;background-size: cover;background-position: center center;">
  <div class="container">
...
<section class = "new-section-8-2 oracle-discover">
 ...
 class = "img-responsive lazyload" width="100%" /> </div>
      ...
      <div class="col-md-2">
        <div class="circle-red-4 hidden-xs hidden-sm" data-aos="fade-left" data-aos-duration="2000"></div>
      </div>
    </div>
  </div>
  <div class="new-section-8-3 container-fluid">
