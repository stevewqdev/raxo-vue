...
<meta name="description" content="Our Work Portfolio - First Key Homes. They came to Raxo for Design, Web Development and Strategy. We fulfilled their requirements within a specific timeline. Contact us today at 646-838-4583!">
		<div class="home-page dark-logo">
  <div class="home-page-4-overlay light"></div>
  <div class="center-container">
    <div class="center-block">
      <h1 class="home-page-4-title light" data-aos="fade-in" data-aos-duration="2000"> FindYourHome</h1>
...
<section class = "section-3">
  <div class="cont-1 container">
    ...
    <div class="row" data-aos="fade-in" data-aos-duration="1000">
      ...
      <div class="col-md-7">
        <p>FirstKey Homes is a rapidly growing nationwide property rental company, slated to own over 100,000 properties by the end of 2018. Currently in over 20 markets nationwide, FirstKey Homes bring a level of dedication and support to its customers not seen anywhere else in the industry.  In the midst of a rebrand, they came to us to build a top-tier real estate website.  Leveraging our UI/UX expertise, integration of 5 API’s, and messaging strategy, we built and maintain one of the best high-functioning rental websites on the internet. </p>
        <br>
      </div>
    </div>
    <div class="row" data-aos="fade-in" data-aos-duration="2000">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="sec-head col-md-3 col-md-offset-1" data-aos="fade-out">
        <h1 style="color:#01dbdc" class="web section-side-heading">Website</h1>
  ...
  <div class="container" style = "padding-top:130px; padding-bottom:130px;">
    <div class="row">
      <div class="col-md-10 col-md-offset-1" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
        <h1 class="bg-text-c"><b>#Home #Strategy<br>
          #WebDesign  #People<br>
          #Responsive #Digital<br>
          #Development #Market<br>
          #RealEstate #Property</b> </h1>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="col-xs-12 col-sm-6 col-md-4" data-aos="fade-up" data-aos-duration="2500">
        <div class="mobile-new-box">
          ...
          <div class="mobile-box-content bottom-content-right">
            <h2>SEARCH</h2>
            <p>The website gives the user the capability to refine their search and truly find the home that is the perfect fit for them.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4" data-aos="fade-up" data-aos-duration="3000">
        <div class="mobile-new-box">
          ...
          <div class="mobile-box-content bottom-content-left">
            <h2>RESULTS</h2>
            <p>Results from the users search map out all of the details on the home and has a clean layout for instant information. </p>
          </div>
        </div>
      </div>
    </div>
