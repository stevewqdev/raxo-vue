...
<meta name="description" content="Our Work Portfolio - Smart Cities. They came to Raxo for Design and Web Development. We fulfilled their requirements within a specific timeline. Contact us today at 646-838-4583!">
  ...
  <section class="parallax-window smart-fondo1" style="background: url();" data-parallax="scroll" data-image-src="assets/img/25-page-2.png" >
    <div class="center-container">
      <div class="center-block">
  ...
  <section class = "section-3">
    <div class="cont-1 container">
      ...
      <div class="row" data-aos="fadeIn" data-aos-duration="2000">
        ...
        <div class="col-md-7">
          <p>Smart Cities is North America’s leading annual three-day conference in New York City showcasing the newest technology and innovation in sustainable and smart urban development. They came to RAXO for a dynamic website that is impactful and informational. We created a seamless website that allows users to get information on the conference and allow them to buy tickets to attend.</p>
          <br>
        </div>
      </div>
      <div class="row" data-aos="fadeIn" data-aos-duration="2000">
  ...
  <section class = "section-4" style="background-color:#FDD607;height: 100%;background-size: cover;background-position: center center;">
    <div class="center-container">
      <div class="center-block">
  ...
  <div class="center-container">
      ...
      <center>
                      <a href="javascript:;" class="js-video-button" data-video-id='274981039' data-channel="vimeo" >
                          <svg version="1.1" id="btnplay_white" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 70.5 19.3" style="enable-background:new 0 0 70.5 19.3;" xml:space="preserve">
                              <g>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
          <div class="mobile-new-box" data-aos="fade-up" data-aos-duration="2000">
            ...
            <div class="mobile-box-content bottom-content-right-2 light-text red-crcl back-curl-icon">
              <h2>ABOUT</h2>
              <p>The user easily gets information on the annual Smart Cities conference in New York City.</p>
            </div>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4">
        ...
        <div class="col-md-4">
          <div class="mobile-new-box" data-aos="fade-up" data-aos-duration="2000">
            ...
            <div class="mobile-box-content bottom-content-left light-text red-crcl back-curl-icon back-curl-icon-slash">
              <h2>PROGRAM</h2>
              <p>Large text and imagery on the desktop site and mobile keep the user interested in the site throughout their user experience.</p>
            </div>
          </div>
        </div>
  ...
  <section class="section-7 smart-website">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="sec-head col-xs-12 col-sm-6 col-md-3 col-md-offset-1" data-aos="slide-up" data-aos-duration="2000">
