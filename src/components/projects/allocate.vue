<template>
	<div class="project__wrapper">
		...
		<meta name="description" content="Our Work Portfolio - Allocate Rite - A Fintech Platform. They came to Raxo for branding, design and web development. We fulfilled requirements. Contact us today!">
		<div class="home-page dark-logo">
			<div class="home-page-19-overlay light"></div>
			<div class="center-container">
				<div class="center-block">
					<h1 class="home-page-10-title light" data-aos="fade-in" data-aos-duration="2000">
					Fintech
					</h1>
					<p class="banner-slogon-text">Design. Branding. Web Development.
					</p>
				</div>
			</div>
		</div>
		...
		<section class = "section-3">
			<div class="cont-1 container">
				...
				<div class="row" data-aos="fade-in" data-aos-duration="2000">
					...
					<div class="col-md-7">
						<p>AllocateRite is fintech platform that enables wealth managers, RIA’s, and high net-worth individuals to reduce risk and maintain earnings.  The product leverages over 250,000 algorithms that perpetually analyze market trends and global economic and social data.  They came to RAXO for branding and web development, to support their go-to-market strategy.
						</p>
						<br>
					</div>
				</div>
		...
		<section class 	= "section-7">
			<div class="container">
				<div class = "Sec-div-19-1">
					<div class = "col-md-6">
					<h1 class = "section-head-19-1" data-aos="fade-out">Responsive<br>Design</h1>
		...
		<div class="container">
			<div class="col-md-4 col-md-offset-8" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
				<h1 class = "section-head-19-1">Black<br>& White</h1>
				<h6 class = "Section-text-19-1">MOBILE</h6>
				<h6 class = "Section-text-19-2">Fully responsive mobile version<br>
			of the website </h6>
			</div>
		</div>
		</section>
