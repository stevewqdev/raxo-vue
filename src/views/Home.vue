<template>
	...
	<meta name="keyword" content="design studios nyc, web design new york, web design company new york, graphic design studios nyc, motion graphic designer, animation studios nyc, motion graphics animation, motion graphics creator, motion graphics designer">

		<div id="mobile-slider-loader">
			<!-- the content -->
		</div>
		<main id="pageContent">
			<div class="imaginary__frame"></div>
			...
			<div class="pagination">
				...
				<span class="line_pagination"></span>
...
export default {
  ...
  mounted(){
    ...
    var allElements = logo.concat(menu).concat(bottomLinks).concat(listElements).concat(buttons).concat(aLinks).concat(inputElements);
	...
	setTimeout(function() { 
		var videoButtons = [...document.querySelectorAll('.has-video')];
		videoButtons.forEach(function(button) {
				button.addEventListener('click', function() {
				let existVideo = [...document.querySelectorAll('.popup__wrapper')];
				...
				let thePopup = document.querySelector('.popup__wrapper');
	...
	videoButtons.forEach(function(button) {
		...
		if(!existVideo.length){
			...
			// Insert the popup into the body
			document.body.appendChild(node); 
			var x = document.getElementById("playing_video");
...
@media(max-width: 4000px){
	...
	.slide-title, .slide-more, .slide-meta{
		left: -10%;
		position: relative;
	}
	.hero p:nth-child(3) {
...
@media (max-width: 500px){
	...
	.slide .slide-meta {
		color: #777777;
		font-size: 12px;    padding-bottom: 55px;    width: 200px;
	}
	.slide-more {
		padding: 11px 15px;
		font-size: 11.5px;
	...
	#slider-loader, .slides, .slide, #pageContent .pagination, #pageContent .pagination .current_page, #pageContent .pagination .total_page {
		pointer-events: none;
...
.slides.scrolling .slide-title, .slides.scrolling .slide-meta{
	pointer-events: none;
	transition: height 0.2s ease-in-out;
}
.slide{
...
.pagination.dark__navigation .current_page, .pagination.dark__navigation .total_page {
	color: #111111!important;
}
...
a.slide-more:hover, a.slide-more:visited, a.slide-more:active, a.slide-more:focus{
	color: #111111!important;
	text-decoration: none;
}
.slide, .slides, .slides.scrolling{
