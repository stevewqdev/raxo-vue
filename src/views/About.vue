...
.reduce-height #grid-logo .cls-1,
.reduce-height #grid-logo .cls-2 {
  fill: #fff;
}
...
.opened #grid-logo .cls-1,
.opened #grid-logo .cls-2 {
  fill: #fff;
}
...
.contact.mobile .cls-1,
.contact.mobile .cls-2 {
  fill: #ffffff;
}
...
@media (max-width: 768px) {
  ...
  .awards__container .about-cols-1 {
    width: 100%;
    padding: 0;
    margin: 0;
  }
...
@media (max-width: 500px) {
  ...
  .about-row-1.row .col-md-9,
  .about-row-1.row .col-md-12 {
    padding: 0px !important;
  }
  .about-section-2 .container {
    width: 90% !important;
