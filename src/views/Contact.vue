    ...
    <div class="contact__page contact__component section__wrapper" >
        ...
        <div class="contact__page__wrapper">
            <div class="form__wrapper">
                <div class="the__form">
                    <form @submit="formSubmit" action="https://api.staticforms.xyz/submit" method="post">
                        <input type="text" name="honeypot" style="display:none">
                        <input type="hidden" name="redirectTo" value="https://raxo.tv/#/contact?submit=true">
                        <input type="hidden" name="accessKey" value="62da1f83-65ea-424b-94ab-a0d2d15e2e9c"> <!--  -->
                        <div class="user__name step_one input__info">
                            <h2 data-aos="fade-up" data-aos-delay="100">Hi! What's Your Name?</h2>
                            <div class="input__wrapper">
                                <label>
                                    <input type="text" class="form-control" name="name" v-model="name" data-aos="fade-up" data-aos-delay="150" >
                                </label>
                            </div> 
                        </div>
                        <div class="company__name step_two input__info">
                            <h2 data-aos="fade-up" data-aos-delay="200">And What's Your Company?</h2>
                            <div class="input__wrapper">
                                <label>
                                    <input type="text" class="form-control" name="$company" v-model="company" data-aos="fade-up" data-aos-delay="300" >
                                </label>
                            </div>
                        </div>
                        <div class="company__name step_three input__info">
                            <h2 data-aos="fade-up" data-aos-delay="200">What’s your e-mail?</h2>
                            <div class="input__wrapper">
                                <label>
                                    <input type="text" class="form-control" name="email" v-model="email" data-aos="fade-up" data-aos-delay="300" >
                                </label>
                            </div>
                        </div>
                        <div class="company__name step_four input__info">
                            <h2 data-aos="fade-up" data-aos-delay="200">Leave us a message</h2>
                            <div class="input__wrapper">
                                <label>
                                    <textarea type="text" class="form-control" name="$message" v-model="message" data-aos="fade-up" data-aos-delay="300" ></textarea>
                                </label>
                            </div>
                        </div>
                        <div class="form__message">
                            <h2 data-aos="fade-up" data-aos-delay="100">Perfect!</h2>
                            <h2 data-aos="fade-up" data-aos-delay="200">We Will Contact You <br> As Soon As Possible :) </h2>
                        </div>
                        <button class="btn form__message__btn" data-step="1" data-aos="fade-up" data-aos-delay="200">Next Step</button>
                    </form>
            ...
            <div class="contact__info">
                <div class="contact__wrapper">
                    <p class="title" data-aos="fade-up" data-aos-delay="200">Contact</p>
                    <a href="mailto:hello@raxo.tv" class="title" ><h4 data-aos="fade-up" data-aos-delay="200">hello@raxo.tv</h4></a>
                    <br>
                    <br>
                    <p class="title" data-aos="fade-up" data-aos-delay="400">Address</p>
                    <a href="https://goo.gl/maps/9MX7fAvdArozoHBn7" target="_BLANK">
                        <h4 class="title" data-aos="fade-up" data-aos-delay="500">12 W 32nd St. 5th Floor. <br> New York, NY, 10001 <br> USA</h4>
                    </a>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
     ...
     mounted(){
        ...
        var submitButton = [...document.querySelectorAll('.form__message__btn')];
        var allElements = logo.concat(menu).concat(bottomLinks).concat(listElements).concat(buttons).concat(aLinks).concat(otherElements).concat(submitButton);        
...
.input__info.step_two, .input__info.step_three, .input__info.step_four{
    display: none;
}
.input__wrapper{
    max-height: 200px;
